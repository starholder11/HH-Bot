    ...
    return (
      <div className="min-h-screen bg-slate-100 text-slate-900">
        <div className="container mx-auto p-6">
          <h1 className="text-3xl font-light tracking-tight mb-6 text-slate-900">Media Library</h1>
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900">
      <div className="container mx-auto p-6">
        ...
        <div className="mb-6">
          <div className="mb-4">
            <h1 className="text-3xl font-light tracking-tight text-slate-900">Media Library</h1>
          </div>
