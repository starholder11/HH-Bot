...
Chapters 4 through 6 are in draft form and a work in progress. They were produced with ChatGPT early in its release cycle using the GPT-3 model. The storyline, events and tone are not quite there and it is questionable whether they will serve as ongoing scaffolding or be replaced when work on the novella resumes. TBD.
