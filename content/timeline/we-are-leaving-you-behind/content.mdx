Five drafts of a letter from an unknown person caught in the bull mania of 2021 to their friend. The letter reflects the sender's realization they are part of a [digital migration](the-digital-frontier), that this moment is different and that a break is occurring.
